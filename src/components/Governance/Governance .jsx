                ...
                <div className="row">
                    ...
                    <div className="col col-lg-6 col-md-12 col-sm-12 col-12">
                        <div className="careers-benefits">
                            <h3>How MTJ Advisory Stands with Global Sharia Advisory Firms?</h3>
                            <ul>
                                <li>Independent Sharia advisory (not product selling)</li>
                                <li>Alignment with AAOIFI, IFSB, and regulatory expectations</li>
                                <li>Strong focus on SMEs alongside institutional clients</li>
                                <li>Practical, implementation driven approach (not academic only)</li>
                    ...
                    <div className="col col-lg-6 col-md-12 col-sm-12 col-12">
                        <div className="careers-benefits">
                            ...
                            <ul>
                                ...
                                <li>Corporates & Family Owned Businesses</li>
                                <li>Financial Institutions & NBFCs</li>
                                <li>Islamic Fintechs & Digital Platforms</li>
                                <li>Investment Companies & Funds</li>
                                <li>Charitable & Social Impact Organizations</li>
                            </ul>
                        </div>
                    </div>
                </div>
